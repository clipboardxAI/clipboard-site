...
ClipboardxAI est disponible pour macOS.

## Options de téléchargement

### Mac App Store (recommandé)

- **Téléchargement** : recherchez **ClipboardxAI** sur le Mac App Store, ou ouvrez le lien depuis la [page d'accueil](/fr/).
...
~~Vous pouvez télécharger la dernière version directement depuis [GitHub Releases](https://github.com/clipboardxAI). Notez que cette version ne reçoit pas de mises à jour automatiques.~~

## Étapes d'installation

### Mac App Store

1. Ouvrez le lien de téléchargement ci-dessus ou recherchez « ClipboardxAI » dans le Mac App Store.
...
3. ~~Glissez l'icône `ClipboardxAI.app` dans votre dossier **Applications**.~~
...
Au premier lancement, ClipboardxAI vous guide à travers une courte configuration :
...
Pour supprimer ClipboardxAI :

1. Quittez l'application.
2. Glissez `ClipboardxAI.app` de `Applications` vers la Corbeille.
