...
- **Eingebaute lokale Werkzeuge**, die vollständig auf Ihrem Mac ausgeführt werden, ohne Netzwerkverbindung.
- **KI-Aktionen**, die ein Cloud-Modell aufrufen, das Sie selbst konfigurieren (Ihr eigener API-Schlüssel, gespeichert im systemeigenen Keychain).
...
- **Extract Links** — extrahiert jede URL aus einem Textblock.
- **Count Stats** — Wort-, Zeichen-, Zeilen- und Satzzählung.
- **Collapse Blank Lines** — bereinigt eingefügten Text in einem Schritt.

Mit der Zeit können weitere lokale Werkzeuge hinzukommen — sie verlassen niemals Ihr Gerät.

### ✨ KI-Aktionen
Senden Sie den aktuellen Eintrag an ein Cloud-Modell, um:

- **Summarize** — lange Artikel und Threads zusammenzufassen.
- **Translate** — zwischen Sprachen zu übersetzen.
- **Rewrite / polish** — Ton und Klarheit zu verbessern.
...
- **Speicher**: ca. 50 MB für die Installation
- **Für Cloud-KI**: ein API-Schlüssel eines unterstützten Anbieters (DeepSeek, MiniMax, Zhipu GLM, Kimi, Mistral, Ollama, OpenAI, Anthropic oder Gemini)

## Unterstützte Sprachen

Die App und diese Website unterstützen Englisch, Vereinfachtes Chinesisch (简体中文), Traditionelles Chinesisch (繁體中文), Japanisch (日本語), Deutsch, Spanisch und Französisch.
